...
public class InputUtils {
    ...
    public static TextChannel parseChannel(Message m, String reference) {
        TextChannel chnl;
        try {
            chnl = AventiBot.getInstance().getJDA().getTextChannelById(reference);
    ...
    public static User parseUser(Message m, String reference) {
        User usr;
        try {
            usr = AventiBot.getInstance().getJDA().getUserById(reference);
        } catch (NumberFormatException e) {
            usr = null;
        }
